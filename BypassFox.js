...
if (process.argv.length <= 2) {
	console.log("node BypassFox.js url time");
        console.log("Created By Punsifer(For No CDN Websites)");
	console.log(":(");
	process.exit(-1);
}
...
const UAs = [
	...
	"WebCopier v4.6",
	"Web Downloader/6.9",
	"WebZIP/3.5 (https://www.spidersoft.com)",
	"Wget/1.9.1",
